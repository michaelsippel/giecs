...
size_t write_ast(std::shared_ptr<ast::Atom<int>> atom, giecs::memory::accessors::Stack<page_size, align_t, addr_t, val_t>& stack)
{
...
template <int page_size, typename align_t, typename addr_t, typename val_t>
size_t write_ast(std::shared_ptr<ast::Atom<std::string>> atom, giecs::memory::accessors::Stack<page_size, align_t, addr_t, val_t>& stack)
{
...
template <int page_size, typename align_t, typename addr_t, typename val_t>
size_t write_ast(std::shared_ptr<ast::List> list, giecs::memory::accessors::Stack<page_size, align_t, addr_t, val_t>& stack)
{
